...
plane_1 = netdem.Plane(0, 0, 1, 0, 0, -1)
plane_2 = netdem.Plane(0, 0, -1, 0, 0, 1)
...
breakage_analysis.strength = 5e3
breakage_analysis.min_breakable_size = 0.8
