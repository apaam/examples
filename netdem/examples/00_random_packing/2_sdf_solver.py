...
# box_stl = netdem.STLModel()
# box_stl.InitFromSTL("data/box.stl")
# for facet in box_stl.facets:
#     triangle = netdem.Triangle(
#         box_stl.vertices[facet[0]],
#         box_stl.vertices[facet[1]],
#         box_stl.vertices[facet[2]],
#     )
